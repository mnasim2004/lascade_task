...
# #     return FileResponse(stl_filename, media_type='application/octet-stream', filename=stl_filename)
...
async def process_image(file: UploadFile = File(...)):
    ...
    # Return the OBJ file as a response
    return FileResponse(obj_filename, media_type='application/octet-stream', filename=obj_filename)
